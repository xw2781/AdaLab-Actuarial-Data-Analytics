...
| `dataset` | `app_server/api/dataset_router.py` | 6 | [Open Domain Index](../app_server/domains/dataset.md) |
| `dataset_types` | `app_server/api/dataset_types_router.py` | 3 | [Open Domain Index](../app_server/domains/dataset_types.md) |
| `debug_trace` | `app_server/api/debug_trace_router.py` | 1 | [Open Domain Index](../app_server/domains/debug_trace.md) |
